...
export const en = {
  ...
  'editor.node.condition.label': 'Decision',
  'editor.node.condition.desc': 'Take a different path based on the result',
  'editor.node.completeness_gate.label': 'Wait for documents',
  'editor.node.completeness_gate.desc': 'Pause until the required documents arrive',
  ...
  'editor.card.condition.header': 'Decision',
  'editor.card.completeness_gate.header': 'Wait',

  // Decision (condition) + Wait-for-documents (completeness_gate) config
  'editor.cond.whenResult': 'When the validation result is',
  'editor.cond.help': 'Matches → the Yes path; otherwise → the No path.',
  'editor.cond.advanced': 'Advanced: check a specific field',
  'editor.cond.field': 'Field',
  'editor.cond.op': 'Comparison',
  'editor.cond.value': 'Value',
  'editor.cond.cardWhen': 'If result is',
  'editor.cond.cardCustom': 'Custom check',
  'editor.branch.yes': 'Yes',
  'editor.branch.no': 'No',
  'editor.gate.heading': 'Wait until these documents are in the dossier',
  'editor.gate.timeout': 'Give up after (days)',
  'editor.gate.help': 'The run pauses and resumes automatically when the documents arrive.',
  'editor.gate.noTypes': 'Add document types in the Library to choose them here.',
  'editor.gate.cardWaiting': 'Waiting for',
  'editor.gate.cardEmpty': 'No documents chosen',
...
export const fr = {
  ...
  'editor.node.condition.label': 'Décision',
  'editor.node.condition.desc': 'Emprunter un chemin différent selon le résultat',
  'editor.node.completeness_gate.label': 'Attendre des documents',
  'editor.node.completeness_gate.desc': 'Mettre en pause jusqu’à l’arrivée des documents requis',
  ...
  'editor.card.condition.header': 'Décision',
  'editor.card.completeness_gate.header': 'Attente',

  'editor.cond.whenResult': 'Lorsque le résultat de la validation est',
  'editor.cond.help': 'Correspond → chemin Oui; sinon → chemin Non.',
  'editor.cond.advanced': 'Avancé : vérifier un champ précis',
  'editor.cond.field': 'Champ',
  'editor.cond.op': 'Comparaison',
  'editor.cond.value': 'Valeur',
  'editor.cond.cardWhen': 'Si le résultat est',
  'editor.cond.cardCustom': 'Vérification personnalisée',
  'editor.branch.yes': 'Oui',
  'editor.branch.no': 'Non',
  'editor.gate.heading': 'Attendre que ces documents soient au dossier',
  'editor.gate.timeout': 'Abandonner après (jours)',
  'editor.gate.help': 'L’exécution se met en pause et reprend automatiquement à l’arrivée des documents.',
  'editor.gate.noTypes': 'Ajoutez des types de documents dans la Bibliothèque pour les choisir ici.',
  'editor.gate.cardWaiting': 'En attente de',
  'editor.gate.cardEmpty': 'Aucun document choisi',
