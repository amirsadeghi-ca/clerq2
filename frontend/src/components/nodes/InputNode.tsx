  ...
  return (
    <div className={[
      ...
      <div className="flex items-center gap-2 border-b border-[var(--c-border)] px-3 py-2">
        ...
        <span className="text-[11px] text-[var(--c-text-4)]">{t('editor.card.input.header')}</span>
      ...
      <div className="px-3 py-2.5">
        <p className="text-[13px] font-medium text-[var(--c-text-1)]">{t('editor.input.title')}</p>
        <p className="mt-0.5 text-[11px] leading-relaxed text-[var(--c-text-4)]">{t('editor.input.subtitle')}</p>
      </div>
