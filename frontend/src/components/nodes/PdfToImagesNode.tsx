  ...
  return (
    <div className={[
      ...
      <div className="flex items-center gap-2 border-b border-[var(--c-border)] px-3 py-2">
        ...
        <span className="text-[11px] text-[var(--c-text-4)]">Transform</span>
      ...
      <div className="px-3 py-2.5">
        <p className="text-[13px] font-medium text-[var(--c-text-1)]">PDF → Images</p>
        <div className="mt-1.5 flex items-center gap-1.5">
          <span className="text-[11px] text-[var(--c-text-4)]">Renders each page as PNG</span>
